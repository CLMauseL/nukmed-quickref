...
const DATA = [
  // --- SPECT Standard ---
  { id: "tc99m-dpd", radionuclide: "Tc-99m", prep: "DPD (Teceos) – Skelett", modality: "SPECT", organ: "Skelett", indications: ["Skelettszintigraphie (Metastasen/Rheuma/Infekt)", "SPECT/CT"], halfLife_h: 6.02, emissions: "γ 140 keV", adultDoseMBq: "500–740 MBq", notes: "Gute Hydrierung; Miktion fördern; Wartezeit je nach Protokoll.", explanation: "99mTc-DPD (Teceos) bindet an Hydroxylapatit in aktivem Knochenumbau – hohe Aufnahme bei osteoblastischer Aktivität (Metastasen, Frakturen, Entzündung)." },
